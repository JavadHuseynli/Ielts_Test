...
CREATE TABLE `open_questions` (
  `id_open` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_open`),
  KEY `idx_question` (`id_question_text`),
  CONSTRAINT `open_questions_ibfk_1` FOREIGN KEY (`id_question_text`) REFERENCES `question_read` (`id_question_text`) ON DELETE CASCADE
...
-- Dump completed on 2025-12-16 13:53:39
